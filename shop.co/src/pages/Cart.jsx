...
export default function Cart() {
    ...
    return(
      <div className="mainMargin flex-col-reverse lg:flex-row flex items-center">
        <div className="text-center flex flex-col items-center gap-5">
          <Reavel>
            <h1 className="bolded text-4xl xsm:text-5xl">¡Gracias por tu compra!</h1>
          </Reavel>
          <Reavel><p>Debes agregar productos antes de continuar al pago</p></Reavel>
          <Reavel className="p-4"><Link className="btn w-fit" to='/Shop'>Ir a la tienda</Link></Reavel>
        </div>
          <motion.div
  ...
  if(!Cost){
    return (
      <div className="mainMargin flex-col-reverse lg:flex-row flex items-center">
        <div className="text-center flex flex-col items-center gap-5">
          <Reavel><h1 className="bolded text-4xl xsm:text-5xl">¡Tu carrito está vacío!</h1></Reavel>
          <Reavel><p>Agrega productos antes de continuar al pago</p></Reavel>
          <Reavel className="p-4"><Link className="btn w-fit" to='/Shop'>Ir a la tienda</Link></Reavel>
        </div>
          <motion.div
            initial={{opacity:0, y:75}}
  ...
  return (
    <div className="mainMargin">
      ...
      <h1 className="bolded text-3xl xsm:text-4xl">Tu carrito</h1>
      <div className="mt-10 flex flex-wrap gap-5">
        ...
        className="p-5 rounded-xl border-2 flex-grow sm:min-w-[450px] h-fit">
          <h1 className="mb-5 font-bold text-xl">Resumen</h1>
          <div className="flex flex-col gap-5">
              ...
              <div>
                <div title="MAXIPAN" className="absolute translate-y-4 translate-x-4"><MdOutlineDiscount size={20}/></div>
                <form onSubmit={handlePromoCode} className="flex flex-wrap gap-5">
                  <input ref={DiscountRef} className="flex-grow bg-gray-100 rounded-full py-3 pl-10 outline-none" placeholder="Ingresa tu código" type="text" />
                  <button className="btn text-center sm:flex-grow-0 flex-grow" type="submit">Aplicar</button>
                </form>
                {CorrectDiscount===false && <p className="font-bold mt-5 text-center text-red-600">Código incorrecto, intenta nuevamente</p>}
                {CorrectDiscount==='Yet' && <p className="font-bold mt-5 text-center">Usa el código MAXIPAN para 20% de descuento</p>}
                {CorrectDiscount===true && <p className="font-bold mt-5 text-center text-green-600">Código aplicado</p>}
              </div>
